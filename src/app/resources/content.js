...
const person = {
  ...
  avatar: "/images/projects/project-01/avatarlangit.jpg",
...
const home = {
  ...
  description: `Portfolio website ${person.name} ${person.role}`,
  headline: <>Selamat datang di website saya Novindra Augustiar </>,
  featured: {
    display: true,
...
const about = {
  ...
  intro: {
    ...
    description: (
      <>
       Saya Novindra Augustiar mahasiswa S1 Teknik Informatika Universitas Jambi.
...
const gallery = {
  ...
  images: [
    ...
    {
      src: "/images/projects/project-01/danaugunung1.webp",
      alt: "image",
      orientation: "horizontal",
    },
    {
      src: "/images/projects/project-01/danaumasurai.jpg",
      alt: "image",
      orientation: "horizontal",
    },
        {
      src: "/images/projects/project-01/gunungmasurai.jpg",
      alt: "image",
      orientation: "horizontal",
    },
  ],
